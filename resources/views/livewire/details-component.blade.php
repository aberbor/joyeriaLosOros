                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/products/product-')}}{{$product->id}}-1.jpg" alt="product image">
                                            </figure>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                            ...
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{route('product.details',['slug'=>$rproduct->slug])}}" tabindex="0">
                                                        ...
                                                        <img class="hover-img" src="{{ asset('assets/imgs/products/product-')}}{{$rproduct->id}}-1.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                                                    <a aria-label="Add To Wishlist" class="action-btn hover-up" href="#" wire:click.prevent="addToWishlist({{$rproduct->id}},'{{$rproduct->name}}',{{$rproduct->regular_price}})"><i class="fi-rs-heart"></i></a>
